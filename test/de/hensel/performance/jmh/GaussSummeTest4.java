...
import static de.hensel.performance.GaussSumme.gaussSumme4;
...
public class GaussSummeTest4 extends PerformanceTest {

    @Override
    public int getExpectedPerformance(String benchmarkName, BenchmarkParams parameter) {
        if ("benchmark_gauss4".equals(benchmarkName)) {
            return 1;
        }
