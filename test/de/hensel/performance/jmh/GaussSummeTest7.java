...
import static de.hensel.performance.GaussSumme.gaussSumme7;
...
public class GaussSummeTest7 extends PerformanceTest {

    @Override
    public int getExpectedPerformance(String benchmarkName, BenchmarkParams parameter) {
        if ("benchmark_gauss7".equals(benchmarkName)) {
            return 1;
        }
